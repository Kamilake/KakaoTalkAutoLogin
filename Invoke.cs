...
namespace MyApp // Note: actual namespace depends on the project name.
{
  ...
  public class Invoke
  {
    ...
    [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Auto)]
    public static extern bool PostMessage(System.IntPtr hWnd, WM Msg, VirtualKeys wParam, IntPtr lParam);
    [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Auto)]
    public static extern bool PostMessage(HandleRef hWnd, uint Msg, uint wParam, IntPtr lParam);
    [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Auto)]
    ...
    [DllImport("user32.dll", SetLastError = true)]
    static extern IntPtr LostFocus(IntPtr hWnd);
    [DllImport("user32.dll", SetLastError = true)]
